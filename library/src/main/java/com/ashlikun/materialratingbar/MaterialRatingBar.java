...
import com.ashlikun.materialratingbar.internal.DrawableCompat;

public class MaterialRatingBar extends RatingBar {
    private int backgroundRes = R.drawable.mrb_star_border_icon_black_36dp;
    private int secondaryProgressRes = R.drawable.mrb_star_border_icon_black_36dp;
    private int progressRes = R.drawable.mrb_star_icon_black_36dp;
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        boolean isNeedInitTint = true;
        Context context = getContext();
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs,
                R.styleable.MaterialRatingBar, defStyleAttr, 0);
        //是否自定义了图片资源
        if (a.hasValue(R.styleable.MaterialRatingBar_mrb_background)) {
            isNeedInitTint = false;
            backgroundRes = a.getResourceId(R.styleable.MaterialRatingBar_mrb_background, backgroundRes);
            secondaryProgressRes = a.getResourceId(R.styleable.MaterialRatingBar_mrb_secondary_progress, backgroundRes);
            progressRes = a.getResourceId(R.styleable.MaterialRatingBar_mrb_progress, progressRes);
        }
        ...
        mDrawable = new MaterialRatingDrawable(getContext(), backgroundRes, secondaryProgressRes, progressRes, isNeedInitTint);
